...
public interface CompletarClaseDiariaHabitoUseCase {
    ...
    /** Longitud mínima del resumen — mismo valor que {@code DAILY_CLASS_SUMMARY_MIN_LENGTH}
     * (RenaserBack {@code habits/service.ts:1543}); repetido acá como red de seguridad propia
     * de este módulo, sin confiar en que el llamador ya validó el contrato HTTP. */
