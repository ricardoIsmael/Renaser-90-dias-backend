...
public interface CerrarRachaUseCase {
    ...
    /** Cierra la racha activa del actor con evidencia. Full-cycle (24h) otorga puntos; hito parcial libera el track. */
    RachaSinCelular cerrar(CerrarRachaCommand command);

    record CerrarRachaCommand(@NotNull UserId actorId) {
        public CerrarRachaCommand {
            SelfValidating.validateConstructorArgs(CerrarRachaCommand.class, actorId);
        }
    }
}
