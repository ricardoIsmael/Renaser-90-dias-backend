 ...
 * (idempotencia del cron nocturno, ningun caso de uso de este modulo lo toca todavia),
 * {@code tipo_meta}, {@code nombre_reto_personal} y {@code habitos_escalonados_en} quedan
 * fuera a proposito (nullable/DEFAULT en Postgres, no hace falta que Hibernate los conozca
 * para un INSERT valido).
 *
