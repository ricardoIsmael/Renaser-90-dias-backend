 ...
 *
 * <p>Los 10 minutos por dia son decision del dueno (2026-09-24, §8 de
 * {@code docs/arquitectura/PROPUESTA_GEMINI_LIVE.md}); los 15 por sesion, el tope de Gemini Live
 * para una sesion de solo audio. Se cambian por entorno sin tocar codigo.
 */
@Configuration
class VozEnVivoConfig {
    ...
    CuotaDeVozEnVivo cuotaDeVozEnVivo(
            @Value("${renaser.ia.voz.en-vivo.minutos-por-dia:10}") long minutosPorDia,
