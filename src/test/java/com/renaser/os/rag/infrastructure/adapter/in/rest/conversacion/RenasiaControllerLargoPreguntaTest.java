...
/**
 * La pregunta tiene tope (auditoria NFR 2026-09-06): sin el, un cliente podia mandar un prompt
 * enorme que se embebia y se enviaba entero al modelo, a cargo de la cuota compartida.
 */
@WebMvcTest(RenasiaController.class)
@AutoConfigureMockMvc(addFilters = false)
class RenasiaControllerLargoPreguntaTest {
    ...
    @Test
    @DisplayName("una pregunta mas larga que el tope es 400 y nunca llega al caso de uso")
    void preguntaDemasiadoLarga() throws Exception {
        String pregunta = "a".repeat(PreguntarRenasiaRequest.LARGO_MAXIMO_PREGUNTA + 1);
    ...
    @Test
    @DisplayName("una pregunta justo en el tope sigue entrando")
    void preguntaEnElLimite() throws Exception {
        String pregunta = "a".repeat(PreguntarRenasiaRequest.LARGO_MAXIMO_PREGUNTA);
