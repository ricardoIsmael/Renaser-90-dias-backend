 ...
 * {@code EspejoSombraService.esMentorAsignado} necesita verificar (D-47), mas la
 * lista de participantes activos para el scheduler.
 */
class FakeParticipacionProgramaFinder implements ParticipacionProgramaFinder {
    ...
    private final List<UserId> participantesActivos = new ArrayList<>();
    ...
    FakeParticipacionProgramaFinder conParticipanteActivo(UserId participanteId) {
        participantesActivos.add(participanteId);
        return this;
    }
    ...
    public List<UserId> participantesInscritosActivos() {
        return List.copyOf(participantesActivos);
    }
