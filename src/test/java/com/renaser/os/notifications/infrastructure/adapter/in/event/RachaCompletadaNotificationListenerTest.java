...
class RachaCompletadaNotificationListenerTest {
    ...
    void traduceElEventoAUnaNotificacionDeLogro() {
        ...
        var event = new RachaCompletadaEvent(rachaId, participante, Instant.now());
        ...
        // C-7: rachaId viaja como origenEventoId -- es la clave que deduplica una redelivery.
        assertThat(captor.getValue().origenEventoId()).isEqualTo(rachaId);
    }
}
