...
/**
 * Cubre solo {@code POST /api/v1/auth/social} (docs/MODULO_AUTH.md §6.1) — el resto de
 * {@link AutenticacionController} (password login/logout/me, reset de contrasena) tiene sus
 * propias pruebas en un archivo separado para no competir por el mismo path de test.
 */
