...
class RegistroRadarPersistenceAdapterTest {
    ...
    void guardaYRecuperaUnRegistro() {
        RegistroRadar registro = RegistroRadar.registrar(RegistroRadarId.of(UUID.randomUUID()), participanteId,
                "haciendo", "pensando", "sintiendo", 7, "evitando", AHORA);
    ...
    void ultimoDeParticipanteDevuelveElMasReciente() {
        adapter.save(RegistroRadar.registrar(RegistroRadarId.of(UUID.randomUUID()), participanteId, "h1", "p1", "s1", 3,
                "e1", AHORA.minus(2, ChronoUnit.HOURS)));
        RegistroRadar masReciente = RegistroRadar.registrar(RegistroRadarId.of(UUID.randomUUID()), participanteId, "h2",
                "p2", "s2", 8, "e2", AHORA);
    ...
    void historialOrdenaDescendenteYRespetaElTamanoDePagina() {
        adapter.save(RegistroRadar.registrar(RegistroRadarId.of(UUID.randomUUID()), participanteId, "h1", "p", "s", 1,
                "e", AHORA.minus(3, ChronoUnit.HOURS)));
        RegistroRadar medio = RegistroRadar.registrar(RegistroRadarId.of(UUID.randomUUID()), participanteId, "h2", "p",
                "s", 2, "e", AHORA.minus(2, ChronoUnit.HOURS));
        adapter.save(medio);
        RegistroRadar masNuevo = RegistroRadar.registrar(RegistroRadarId.of(UUID.randomUUID()), participanteId, "h3",
                "p", "s", 3, "e", AHORA);
    ...
    void historialFiltraPorCursorTraeSoloLosMasViejos() {
        RegistroRadar viejo = RegistroRadar.registrar(RegistroRadarId.of(UUID.randomUUID()), participanteId, "h1", "p",
                "s", 1, "e", AHORA.minus(2, ChronoUnit.HOURS));
        adapter.save(viejo);
        Instant cursor = AHORA.minus(1, ChronoUnit.HOURS);
        adapter.save(RegistroRadar.registrar(RegistroRadarId.of(UUID.randomUUID()), participanteId, "h2", "p", "s", 2,
                "e", cursor));
        adapter.save(RegistroRadar.registrar(RegistroRadarId.of(UUID.randomUUID()), participanteId, "h3", "p", "s", 3,
                "e", AHORA));
    ...
    void historialFiltraSoloLosRegistrosDelParticipante() {
        ...
        adapter.save(RegistroRadar.registrar(RegistroRadarId.of(UUID.randomUUID()), participanteId, "mio", "p", "s", 5,
                "e", AHORA));
        adapter.save(RegistroRadar.registrar(RegistroRadarId.of(UUID.randomUUID()), otroParticipante, "ajeno", "p", "s",
                5, "e", AHORA));
    ...
    void totalRegistrosRadarCuentaSoloLosDelParticipante() {
        ...
        seedParticipante(otroParticipante);
        adapter.save(RegistroRadar.registrar(RegistroRadarId.of(UUID.randomUUID()), participanteId, "h1", "p", "s", 1,
                "e", AHORA.minus(1, ChronoUnit.HOURS)));
        adapter.save(RegistroRadar.registrar(RegistroRadarId.of(UUID.randomUUID()), participanteId, "h2", "p", "s", 2,
                "e", AHORA));
        adapter.save(RegistroRadar.registrar(RegistroRadarId.of(UUID.randomUUID()), otroParticipante, "ajeno", "p", "s",
                3, "e", AHORA));
    ...
    void primerRegistroRadarEnDevuelveElMasAntiguo() {
        adapter.save(RegistroRadar.registrar(RegistroRadarId.of(UUID.randomUUID()), participanteId, "h1", "p", "s", 1,
                "e", AHORA.minus(2, ChronoUnit.HOURS)));
        adapter.save(RegistroRadar.registrar(RegistroRadarId.of(UUID.randomUUID()), participanteId, "h2", "p", "s", 2,
                "e", AHORA));
